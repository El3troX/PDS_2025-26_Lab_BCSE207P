...
cat("Result of division 5 and 10:", result1, "\n") 
cat("Result of division -3 and 7:", result2, "\n") 
cat("Result of division 0 and 0:", result3, "\n") 
cat("Result of division 3.5 and 2.1:", result4, "\n") 